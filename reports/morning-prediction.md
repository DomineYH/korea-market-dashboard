...
- 생성 시각: `2026-09-07T12:19:40+09:00`
- 단기 판정: **중립/상승 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **1.38** = 상승 4.5 + 하락 -3.12

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,897.04 | 2026-09-07 12:11 |
| KOSDAQ | 824.21 | 2026-09-07 10:07 |
| USD/KRW | 1,345.98 | 1M -5.37% |
| SOX | 1W 2.32% | 1M -2.60% |
| VIX | 14.53 | 위험선호/공포 지표 |
| WTI | 91.48 | 1M 17.01% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/상승 경계 | 조건부 상승 | 1.38 | 4.5 | -3.12 |
| KOSDAQ | 상승 우세 | 상승 우세 | 2.38 | 5.0 | -2.62 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +9.54%, 3M -7.85%, 6M +23.52% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -8,935억, 10D -61,849억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -56,593억, 기관 5D 7,777억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,345.98, 1M -5.37% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 14.53 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 91.48달러, 1M +17.01% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +4.89%, 자동차 +0.00% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 59.63% | 1.63% | 0.19 | 모멘텀 롱 |
