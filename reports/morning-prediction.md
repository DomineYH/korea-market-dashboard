...
- 생성 시각: `2026-06-29T09:59:47+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,320.14 | 2026-06-29 09:46 |
| KOSDAQ | 902.60 | 2026-06-29 09:53 |
| USD/KRW | 1,539.39 | 1M 2.95% |
| SOX | 1W -7.94% | 1M 3.95% |
| VIX | 18.41 | 위험선호/공포 지표 |
| WTI | 70.02 | 1M -21.24% |
...
| KOSDAQ | 중립 | 상승 우세 | -0.42 | 4.0 | -4.42 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -0.10%, 3M +49.76%, 6M +104.72% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -165,712억, 10D -176,556억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 186,175억, 기관 5D -25,103억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,539.39, 1M +2.95% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 18.41 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 70.02달러, 1M -21.24% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -3.10%, 자동차 +0.00% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 59.36% | 2.38% | 0.19 | 모멘텀 롱 |
| KOSDAQ | 219 | 56.16% | 0.37% | 0.12 | 모멘텀 롱 |
