...
- 생성 시각: `2026-07-21T11:45:04+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,713.75 | 2026-07-21 11:23 |
| KOSDAQ | 738.29 | 2026-07-21 11:10 |
| USD/KRW | 1,479.30 | 1M -3.40% |
| SOX | 1W -4.89% | 1M -12.86% |
| VIX | 18.65 | 위험선호/공포 지표 |
| WTI | 82.34 | 1M 7.23% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -26.32%, 3M +7.12%, 6M +42.13% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 25,199억, 10D -19,126억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -34,321억, 기관 5D 8,325억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,479.30, 1M -3.40% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 18.65 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 82.34달러, 1M +7.23% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +4.56%, 자동차 +0.00% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 62.10% | 1.96% | 0.24 | 모멘텀 롱 |
| KOSDAQ | 219 | 57.53% | 0.12% | 0.15 | 모멘텀 롱 |
