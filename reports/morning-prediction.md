...
- 생성 시각: `2026-08-20T10:15:43+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,779.57 | 2026-08-20 10:08 |
| KOSDAQ | 836.51 | 2026-08-20 09:55 |
| USD/KRW | 1,393.98 | 1M -5.79% |
| SOX | 1W -5.33% | 1M -5% |
| VIX | 14.89 | 위험선호/공포 지표 |
| WTI | 84.74 | 1M -0.20% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +4.10%, 3M -9.75%, 6M +27.95% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 19,819억, 10D -7,745억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 1,923억, 기관 5D -24,432억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,393.98, 1M -5.79% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 14.89 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 84.74달러, 1M -0.20% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 61.93% | 1.79% | 0.24 | 모멘텀 롱 |
| KOSDAQ | 217 | 56.22% | 0.17% | 0.12 | 모멘텀 롱 |
