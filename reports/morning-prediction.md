...
- 생성 시각: `2026-08-12T10:59:26+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,568.54 | 2026-08-12 10:31 |
| KOSDAQ | 855.36 | 2026-08-12 10:02 |
| USD/KRW | 1,414.76 | 1M -5.54% |
| SOX | 1W -0.66% | 1M -2.02% |
| VIX | 15.28 | 위험선호/공포 지표 |
| WTI | 83.73 | 1M 7.15% |
...
| KOSDAQ | 중립 | 중립/상승 경계 | -0.44 | 3.56 | -4.0 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -3.95%, 3M -14.46%, 6M +21.73% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -46,534억, 10D 21,684억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 30,594억, 기관 5D 16,351억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,414.76, 1M -5.54% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -0.66%, 1M -2.02% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 리스크 | VIX | 15.28 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 83.73달러, 1M +7.15% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +5.14%, 자동차 +0.00% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
| KOSDAQ | 218 | 57.34% | 0.13% | 0.15 | 모멘텀 롱 |
