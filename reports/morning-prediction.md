...
- 생성 시각: `2026-07-22T11:42:38+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **3.41** = 상승 5.0 + 하락 -1.59

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,094.42 | 2026-07-22 11:21 |
| KOSDAQ | 771.30 | 2026-07-22 09:03 |
| USD/KRW | 1,479.72 | 1M -3.85% |
| SOX | 1W -2.41% | 1M -13.84% |
| VIX | 17.05 | 위험선호/공포 지표 |
| WTI | 85.13 | 1M 11.14% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 3.41 | 5.0 | -1.59 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -1.59 | 3.5 | -5.09 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -21.83%, 3M +15.07%, 6M +50.86% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 37,055억, 10D 31,467억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -17,581억, 기관 5D -20,097억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,479.72, 1M -3.85% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -2.41%, 1M -13.84% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 리스크 | VIX | 17.05 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 85.13달러, 1M +11.14% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 62.10% | 1.98% | 0.24 | 모멘텀 롱 |
| KOSDAQ | 219 | 57.99% | 0.12% | 0.16 | 모멘텀 롱 |
