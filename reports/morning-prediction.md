...
- 생성 시각: `2026-08-28T19:00:32+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,788.88 | 2026-08-28 18:34 |
| KOSDAQ | 838.41 | 2026-08-28 17:40 |
| USD/KRW | 1,371.68 | 1M -4.90% |
| SOX | 1W 0.70% | 1M 13.73% |
| VIX | 14.50 | 위험선호/공포 지표 |
| WTI | 83.14 | 1M -0.54% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +19.88%, 3M -17.06%, 6M +13.72% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -83,171억, 10D -71,288억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 6,343억, 기관 5D -3,616억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,371.68, 1M -4.90% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +0.70%, 1M +13.73% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.672%, 1M +1.08% | 하락 | -1.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 14.50 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 83.14달러, 1M -0.54% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -3.74%, 자동차 +0.00% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 61.64% | 1.80% | 0.23 | 모멘텀 롱 |
| KOSDAQ | 219 | 56.16% | 0.15% | 0.12 | 모멘텀 롱 |
