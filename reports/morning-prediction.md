...
- 생성 시각: `2026-09-16T12:43:54+09:00`
- 단기 판정: **중립/하락 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-1.68** = 상승 4.5 + 하락 -6.18
...
| KOSPI | N/A |  |
| KOSDAQ | N/A |  |
| USD/KRW | 1,366.86 | 1M -3.38% |
| SOX | 1W -5.99% | 1M -10% |
| VIX | 17.20 | 위험선호/공포 지표 |
| WTI | 104.65 | 1M 23.85% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/하락 경계 | 조건부 상승 | -1.68 | 4.5 | -6.18 |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -2.62%, 3M -24.53%, 6M +20.54% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -110,299억, 10D -77,589억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 55,300억, 기관 5D -19,795억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,366.86, 1M -3.38% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 17.20 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 104.65달러, 1M +23.85% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| KOSDAQ | 219 | 52.05% | 0.02% | 0.04 | 모멘텀 롱 |
