...
- 생성 시각: `2026-08-19T10:15:53+09:00`
- 단기 판정: **중립/상승 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **1.64** = 상승 4.5 + 하락 -2.86

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,580.08 | 2026-08-19 10:04 |
| KOSDAQ | 837.54 | 2026-08-19 09:32 |
| USD/KRW | 1,408.48 | 1M -4.51% |
| SOX | 1W -0.88% | 1M 2.12% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/상승 경계 | 조건부 상승 | 1.64 | 4.5 | -2.86 |
| KOSDAQ | 하락/조정 우세 | 중립 | -2.36 | 3.0 | -5.36 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -4.38%, 3M -12.97%, 6M +23.09% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 66,808억, 10D 25,354억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -50,535억, 기관 5D -14,351억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,408.48, 1M -4.51% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -0.88%, 1M +2.12% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 원자재 | WTI 유가 | 84.79달러, 1M +1.87% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -5.99%, 자동차 -3.46% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 62.39% | 1.74% | 0.25 | 모멘텀 롱 |
| KOSDAQ | 217 | 56.68% | 0.18% | 0.13 | 모멘텀 롱 |
