...
- 생성 시각: `2026-07-20T19:14:17+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.42** = 상승 5.0 + 하락 -2.58

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,516.27 | 2026-07-20 18:30 |
| KOSDAQ | 749.64 | 2026-07-20 18:30 |
| USD/KRW | 1,481.41 | 1M -3.65% |
| SOX | 1W -9.97% | 1M -12.19% |
| VIX | 18.35 | 위험선호/공포 지표 |
| WTI | 81.33 | 1M 5.91% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.42 | 5.0 | -2.58 |
| KOSDAQ | 하락/조정 우세 | 중립/하락 경계 | -2.58 | 3.5 | -6.08 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -28.11%, 3M +6.98%, 6M +40.90% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 7,424억, 10D -33,340억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 12,929억, 기관 5D -21,295억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,481.41, 1M -3.65% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 18.35 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 81.33달러, 1M +5.91% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
