...
- 생성 시각: `2026-09-18T21:06:54+09:00`
...
| KOSPI | N/A |  |
| KOSDAQ | N/A |  |
| USD/KRW | 1,387.58 | 1M -0.13% |
| SOX | 1W -0.13% | 1M -3.28% |
| VIX | 15.39 | 위험선호/공포 지표 |
| WTI | 96.28 | 1M 12.18% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +0.61%, 3M -23.84%, 6M +16.36% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
...
| 환율 | USD/KRW | 1,387.58, 1M -0.13% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.39 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 96.28달러, 1M +12.18% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
