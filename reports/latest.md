...
- 생성 시각: `2026-06-17T17:47:18+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,864.24 | 2026-06-17 16:43 |
| KOSDAQ | 1,031.96 | 2026-06-17 17:32 |
| USD/KRW | 1,513.92 | 1M 1.45% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +18.30%, 3M +59.72%, 6M +113.35% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 23,529억, 10D -121,234억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -53,880억, 기관 5D 32,666억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,513.92, 1M +1.45% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 원자재 | WTI 유가 | 75.73달러, 1M -30.31% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +3.21%, 자동차 -2.95% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 220 | 59.55% | 2.35% | 0.19 | 모멘텀 롱 |
| KOSDAQ | 220 | 53.64% | 0.62% | 0.07 | 모멘텀 롱 |
