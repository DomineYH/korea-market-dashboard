...
- 생성 시각: `2026-08-05T11:34:24+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,582.74 | 2026-08-05 10:54 |
| KOSDAQ | 797.04 | 2026-08-05 09:42 |
| USD/KRW | 1,423.68 | 1M -6.87% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -18.18%, 3M +0.28%, 6M +30.14% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 58,031억, 10D -39,615억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -50,102억, 기관 5D -9,173억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,423.68, 1M -6.87% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 원자재 | WTI 유가 | 74.96달러, 1M +9.35% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 64.22% | 1.71% | 0.28 | 모멘텀 롱 |
| KOSDAQ | 218 | 59.17% | -0.14% | 0.18 | 모멘텀 롱 |
