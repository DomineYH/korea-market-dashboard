...
- 생성 시각: `2026-05-28T17:23:09+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.55** = 상승 6.5 + 하락 -3.95

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,185.29 | 2026-05-28 16:52 |
| KOSDAQ | 1,104.36 | 2026-05-28 16:07 |
| USD/KRW | 1,502.68 | 1M 2.08% |
| SOX | 1W 12.35% | 1M 22.04% |
| VIX | 16.68 | 위험선호/공포 지표 |
| WTI | 90.88 | 1M -9.06% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.55 | 6.5 | -3.95 |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +26.40%, 3M +37.12%, 6M +108.30% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -54,204억, 10D -254,738억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 18,548억, 기관 5D 35,754억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,502.68, 1M +2.08% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 16.68 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 90.88달러, 1M -9.06% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| KOSDAQ | 219 | 54.34% | 0.93% | 0.09 | 모멘텀 롱 |
