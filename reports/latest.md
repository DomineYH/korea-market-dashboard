...
- 생성 시각: `2026-08-04T18:39:04+09:00`
- 단기 판정: **중립/상승 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **1.29** = 상승 5.0 + 하락 -3.71

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,358.95 | 2026-08-04 18:32 |
| KOSDAQ | 780.72 | 2026-08-04 18:02 |
| USD/KRW | 1,433.26 | 1M -6.38% |
| SOX | 1W -4.30% | 1M -15.29% |
| VIX | 15.82 | 위험선호/공포 지표 |
| WTI | 82.10 | 1M 19.52% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/상승 경계 | 조건부 상승 | 1.29 | 5.0 | -3.71 |
| KOSDAQ | 중립 | 상승 우세 | 0.29 | 4.5 | -4.21 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -16.86%, 3M -4.96%, 6M +28.47% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 41,252억, 10D -17,681억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -62,140억, 기관 5D 19,176억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,433.26, 1M -6.38% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.82 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 82.10달러, 1M +19.52% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +0.00%, 자동차 -0.04% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
| 국내금리 | 한국은행 기준금리 | 2.50% | 상승 | 0.5 | 중간 | 국내 기준금리 안정은 밸류에이션 하방을 일부 완충한다. |
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=neutral, 실제=bearish(-1.07%) | 하락 | -0.21 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |
...
| KOSDAQ | 218 | 59.17% | -0.16% | 0.18 | 모멘텀 롱 |
...
- 누적 표본: 55
- 누적 적중률: 38.18%
- 최근 피드백: 전일 09시 예측 불일치: 예측=neutral, 실제=bearish(-1.07%)
