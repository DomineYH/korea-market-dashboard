...
- 생성 시각: `2026-09-17T21:27:55+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.32** = 상승 5.5 + 하락 -3.18
...
| KOSPI | N/A |  |
| KOSDAQ | N/A |  |
| USD/KRW | 1,378.35 | 1M -2.49% |
| SOX | 1W -5.74% | 1M -10.89% |
| VIX | 15.68 | 위험선호/공포 지표 |
| WTI | 99.77 | 1M 17.46% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.32 | 5.5 | -3.18 |
| KOSDAQ | 중립/상승 경계 | 상승 우세 | 1.32 | 5.0 | -3.68 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +3.77%, 3M -25.91%, 6M +19.06% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
...
| 환율 | USD/KRW | 1,378.35, 1M -2.49% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.68 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 99.77달러, 1M +17.46% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
- [코스피 7000 재돌파할까…다음주 증시 향방 가를 3대 변수는? - 한국경제](https://news.google.com/rss/articles/CBMiWkFVX3lxTFBvOE82RnJDdXIzbmxEb3BoWGdhbzMwbXJjUlNDVk5ZVmRZcGV3RWlXMzdvVExYaTZvSnpQckNlN1p6UVBVQmxQTnp1TTJCNl84VUNyMGJUVjMtUQ?oc=5) — 한국경제
