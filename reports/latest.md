...
- 생성 시각: `2026-07-30T18:32:00+09:00`
- 단기 판정: **하락/조정 우세** / 신뢰도: 중간~높음
- 중기 판정: **하락/조정 우세** / 신뢰도: 중간~높음
- 총점: **-4.09** = 상승 3.5 + 하락 -7.59

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 5,593.56 | 2026-07-30 18:04 |
| KOSDAQ | 644.78 | 2026-07-30 16:06 |
| USD/KRW | 1,436.97 | 1M -7.21% |
| SOX | 1W -15.82% | 1M -23.79% |
| VIX | 19.56 | 위험선호/공포 지표 |
| WTI | 83.90 | 1M 20.72% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 하락/조정 우세 | 하락/조정 우세 | -4.09 | 3.5 | -7.59 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -1.09 | 4.0 | -5.09 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -34.01%, 3M -15.44%, 6M +12.94% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -105,725억, 10D -63,670억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 80,712억, 기관 5D 23,485억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,436.97, 1M -7.21% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 19.56 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 83.90달러, 1M +20.72% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -3.05%, 자동차 +0.00% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 63.93% | 1.72% | 0.28 | 모멘텀 롱 |
| KOSDAQ | 219 | 58.90% | -0.12% | 0.18 | 모멘텀 롱 |
