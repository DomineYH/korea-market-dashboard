...
- 생성 시각: `2026-09-09T12:30:16+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,059.06 | 2026-09-09 12:13 |
| KOSDAQ | 827.04 | 2026-09-09 09:28 |
| USD/KRW | 1,337.78 | 1M -5.61% |
| SOX | 1W 3.06% | 1M -3.79% |
| VIX | 15.72 | 위험선호/공포 지표 |
| WTI | 94.58 | 1M 15.16% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +12.04%, 3M -8.70%, 6M +34.39% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 36,014억, 10D -1,753억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -161,691억, 기관 5D 66,071억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,337.78, 1M -5.61% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.72 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 94.58달러, 1M +15.16% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
