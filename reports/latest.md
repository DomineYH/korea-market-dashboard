...
- 생성 시각: `2026-06-15T10:05:54+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **3.86** = 상승 6.5 + 하락 -2.64

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,588.35 | 2026-06-15 09:58 |
| KOSDAQ | 1,034.80 | 2026-06-15 09:19 |
| USD/KRW | 1,508.48 | 1M 1.01% |
| SOX | 1W 9.42% | 1M 11.26% |
| VIX | 17.68 | 위험선호/공포 지표 |
| WTI | 81.02 | 1M -19.92% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 3.86 | 6.5 | -2.64 |
| KOSDAQ | 상승 우세 | 상승 우세 | 4.36 | 6.0 | -1.64 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +9.07%, 3M +53.23%, 6M +112.37% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -36,353억, 10D -224,552억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 9,373억, 기관 5D 24,551억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,508.48, 1M +1.01% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 17.68 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 81.02달러, 1M -19.92% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=neutral, 실제=bearish(-2.75%) | 하락 | -0.14 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 59.82% | 2.26% | 0.20 | 모멘텀 롱 |
| KOSDAQ | 219 | 54.34% | 0.58% | 0.09 | 모멘텀 롱 |
...
- 누적 표본: 19
- 누적 적중률: 42.11%
- 최근 피드백: 전일 09시 예측 불일치: 예측=neutral, 실제=bearish(-2.75%)
