...
- 생성 시각: `2026-09-23T21:37:13+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **5.32** = 상승 6.5 + 하락 -1.18
...
| KOSPI | N/A |  |
| KOSDAQ | N/A |  |
| USD/KRW | 1,367.68 | 1M -0.95% |
| SOX | 1W 11.70% | 1M 5.37% |
| VIX | 14.33 | 위험선호/공포 지표 |
| WTI | 90.76 | 1M 6.76% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 5.32 | 6.5 | -1.18 |
| KOSDAQ | 상승 우세 | 상승 우세 | 4.32 | 6.0 | -1.68 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +5.73%, 3M -13.69%, 6M +22.48% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 0억, 10D 0억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 0억, 기관 5D 0억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,367.68, 1M -0.95% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +11.70%, 1M +5.37% | 하락 | 1.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.992%, 1M +5.36% | 하락 | -1.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 14.33 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 90.76달러, 1M +6.76% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 55.96% | 1.42% | 0.12 | 모멘텀 롱 |
| KOSDAQ | 218 | 50.46% | 0.00% | 0.01 | 모멘텀 롱 |
...
- [코스피, 반도체주 약세에 8300선 후퇴…환율 1550원대 마감 - straightnews.co.kr](https://news.google.?oc=5) — straightnews.co.kr
