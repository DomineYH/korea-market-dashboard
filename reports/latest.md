...
- 생성 시각: `2026-06-08T17:38:27+09:00`
- 단기 판정: **하락/조정 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-3.86** = 상승 3.64 + 하락 -7.5

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,484.41 | 2026-06-08 17:32 |
| KOSDAQ | 911.39 | 2026-06-08 17:32 |
| USD/KRW | 1,530.82 | 1M 5.23% |
| SOX | 1W -4.74% | 1M 6.52% |
| VIX | 19.93 | 위험선호/공포 지표 |
| WTI | 94.65 | 1M -0.17% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 하락/조정 우세 | 조건부 상승 | -3.86 | 3.64 | -7.5 |
| KOSDAQ | 중립 | 상승 우세 | 0.14 | 4.64 | -4.5 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +1.35%, 3M +34.04%, 6M +87.72% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -189,098억, 10D -249,968억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 177,404억, 기관 5D 9,060억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,530.82, 1M +5.23% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 19.93 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 94.65달러, 1M -0.17% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -9.14%, 자동차 +0.00% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 62.10% | 2.39% | 0.24 | 모멘텀 롱 |
| KOSDAQ | 219 | 55.25% | 0.66% | 0.10 | 모멘텀 롱 |
