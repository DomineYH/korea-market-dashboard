...
- 생성 시각: `2026-08-10T17:27:50+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.7** = 상승 5.2 + 하락 -2.5

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,299.66 | 2026-08-10 16:36 |
| KOSDAQ | 854.47 | 2026-08-10 17:21 |
| USD/KRW | 1,417.95 | 1M -5.84% |
| SOX | 1W 9.25% | 1M -4.65% |
| VIX | 15.49 | 위험선호/공포 지표 |
| WTI | 78.36 | 1M 9.73% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.7 | 5.2 | -2.5 |
| KOSDAQ | 중립/상승 경계 | 상승 우세 | 0.7 | 4.7 | -4.0 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -13.61%, 3M -15.98%, 6M +27.27% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -45,682억, 10D -45,723억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 41,388억, 기관 5D 2,086억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,417.95, 1M -5.84% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +9.25%, 1M -4.65% | 하락 | 1.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.660%, 1M +2.67% | 하락 | -1.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 15.49 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 78.36달러, 1M +9.73% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=neutral, 실제=bullish(+0.62%) | 상승 | 0.2 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 63.76% | 1.71% | 0.28 | 모멘텀 롱 |
| KOSDAQ | 218 | 57.80% | 0.10% | 0.16 | 모멘텀 롱 |
...
- 누적 표본: 59
- 누적 적중률: 38.98%
- 최근 피드백: 전일 09시 예측 불일치: 예측=neutral, 실제=bullish(+0.62%)
