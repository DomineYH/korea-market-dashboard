...
- 생성 시각: `2026-07-27T12:16:16+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,666.55 | 2026-07-27 11:50 |
| KOSDAQ | 762.92 | 2026-07-27 11:13 |
| USD/KRW | 1,466.10 | 1M -5.20% |
| SOX | 1W 4.01% | 1M -8.45% |
| VIX | 18.58 | 위험선호/공포 지표 |
| WTI | 85.34 | 1M 18.66% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -25.81%, 3M +3.23%, 6M +35.08% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -1,607억, 10D 5,817억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 18,212억, 기관 5D -16,898억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,466.10, 1M -5.20% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 금리 | 미국 10년물 | 4.679%, 1M +6.29% | 하락 | -1.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 18.58 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 85.34달러, 1M +18.66% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 63.76% | 1.94% | 0.28 | 모멘텀 롱 |
