...
- 생성 시각: `2026-05-19T13:08:18+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,250.33 | 2026-05-19 12:04 |
| KOSDAQ | 1,072.24 | 2026-05-19 12:05 |
| USD/KRW | 1,505.32 | 1M 2.74% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +17.42%, 3M +36.53%, 6M +78.02% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -193,139억, 10D -366,245억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 171,259억, 기관 5D 16,865억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,505.32, 1M +2.74% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +0.00%, 자동차 -7.90% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
