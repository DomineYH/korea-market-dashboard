...
- 생성 시각: `2026-06-15T18:13:45+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,545.98 | 2026-06-15 18:02 |
| KOSDAQ | 1,034.03 | 2026-06-15 15:52 |
| USD/KRW | 1,513.37 | 1M 1.34% |
...
| KOSDAQ | 상승 우세 | 상승 우세 | 2.36 | 5.0 | -2.64 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +8.95%, 3M +53.06%, 6M +112.14% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -29,643억, 10D -217,842억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 4,981억, 기관 5D 22,154억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,513.37, 1M +1.34% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 원자재 | WTI 유가 | 80.19달러, 1M -20.74% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
