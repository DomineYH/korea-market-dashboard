...
- 생성 시각: `2026-05-22T17:11:33+09:00`
- 단기 판정: **중립/하락 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-0.69** = 상승 5.81 + 하락 -6.5

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,847.71 | 2026-05-22 17:01 |
| KOSDAQ | 1,161.13 | 2026-05-22 16:40 |
| USD/KRW | 1,516.33 | 1M 2.60% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/하락 경계 | 조건부 상승 | -0.69 | 5.81 | -6.5 |
| KOSDAQ | 중립/상승 경계 | 조건부 상승 | 1.81 | 5.31 | -3.5 |
...
| 수급 | KOSPI 외국인 순매수 | 5D -144,479억, 10D -343,433억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 79,390억, 기관 5D 63,140억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,516.33, 1M +2.60% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 원자재 | WTI 유가 | 98.34달러, 1M +2.60% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
