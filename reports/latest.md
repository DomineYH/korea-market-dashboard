...
- 생성 시각: `2026-06-22T18:06:55+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.23** = 상승 6.0 + 하락 -3.77

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 9,114.55 | 2026-06-22 18:01 |
| KOSDAQ | 968.40 | 2026-06-22 17:55 |
| USD/KRW | 1,536.99 | 1M 2.17% |
| SOX | 1W 8.89% | 1M 26.86% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.23 | 6.0 | -3.77 |
| KOSDAQ | 상승 우세 | 상승 우세 | 2.73 | 5.5 | -2.77 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +26.43%, 3M +58.15%, 6M +121.73% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -10,844억, 10D -40,487억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 17,241억, 기관 5D -3,855억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,536.99, 1M +2.17% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +8.89%, 1M +26.86% | 하락 | 1.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 원자재 | WTI 유가 | 75.17달러, 1M -23.50% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +3.21%, 자동차 -4.10% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
| 국내금리 | 한국은행 기준금리 | 2.50% | 상승 | 0.5 | 중간 | 국내 기준금리 안정은 밸류에이션 하방을 일부 완충한다. |
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=bullish, 실제=bearish(-3.30%) | 하락 | -0.27 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 60.73% | 2.53% | 0.21 | 모멘텀 롱 |
| KOSDAQ | 219 | 53.88% | 0.58% | 0.08 | 모멘텀 롱 |
...
- 누적 표본: 24
- 누적 적중률: 45.83%
- 최근 피드백: 전일 09시 예측 불일치: 예측=bullish, 실제=bearish(-3.30%)
