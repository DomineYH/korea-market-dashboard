...
- 생성 시각: `2026-06-09T17:16:51+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-0.04** = 상승 5.5 + 하락 -5.54

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 8,096.93 | 2026-06-09 16:45 |
| KOSDAQ | 967.81 | 2026-06-09 16:37 |
| USD/KRW | 1,521.51 | 1M 4.17% |
| SOX | 1W -0.45% | 1M 15.64% |
| VIX | 18.32 | 위험선호/공포 지표 |
| WTI | 89.72 | 1M -5.97% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립 | 조건부 상승 | -0.04 | 5.5 | -5.54 |
| KOSDAQ | 상승 우세 | 상승 우세 | 2.46 | 5.0 | -2.54 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +8.10%, 3M +44.98%, 6M +106.21% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -180,038억, 10D -249,906억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 167,357억, 기관 5D 8,779억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,521.51, 1M +4.17% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 18.32 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 89.72달러, 1M -5.97% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +11.80%, 자동차 +0.00% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
| 국내금리 | 한국은행 기준금리 | 2.50% | 상승 | 0.5 | 중간 | 국내 기준금리 안정은 밸류에이션 하방을 일부 완충한다. |
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 적중: 예측=bearish, 실제=bearish(-2.42%) | 하락 | -0.04 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 220 | 61.82% | 2.34% | 0.24 | 모멘텀 롱 |
| KOSDAQ | 220 | 55.45% | 0.62% | 0.11 | 모멘텀 롱 |
...
- 누적 표본: 15
- 누적 적중률: 46.67%
- 최근 피드백: 전일 09시 예측 적중: 예측=bearish, 실제=bearish(-2.42%)
