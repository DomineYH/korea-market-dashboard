...
- 생성 시각: `2026-07-07T12:29:41+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,484.92 | 2026-07-07 11:48 |
| KOSDAQ | 823.65 | 2026-07-07 |
| USD/KRW | 1,521.88 | 1M -2.10% |
| SOX | 1W -2.30% | 1M -7.31% |
| VIX | 15.57 | 위험선호/공포 지표 |
| WTI | 69.09 | 1M -25.74% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +1.19%, 3M +40.84%, 6M +79.44% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -120,803억, 10D -334,333억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 110,405억, 기관 5D 6,094억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,521.88, 1M -2.10% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 금리 | 미국 10년물 | 4.479%, 1M -0.27% | 하락 | 0.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 15.57 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 69.09달러, 1M -25.74% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -8.85%, 자동차 -6.74% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
