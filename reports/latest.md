...
- 생성 시각: `2026-08-17T16:53:39+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **4.47** = 상승 5.0 + 하락 -0.53

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,977.94 | 2026-08-17 06:10 |
| KOSDAQ | 864.65 | 2026-08-17 10:52 |
| USD/KRW | 1,411.74 | 1M -4.54% |
| SOX | 1W 0.49% | 1M 0.56% |
| VIX | 14.95 | 위험선호/공포 지표 |
| WTI | 81.68 | 1M -0.98% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 4.47 | 5.0 | -0.53 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -0.53 | 3.5 | -4.03 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -6.66%, 3M -10.79%, 6M +31.96% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
...
| 환율 | USD/KRW | 1,411.74, 1M -4.54% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +0.49%, 1M +0.56% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.696%, 1M +0.00% | 하락 | 0.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 14.95 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 81.68달러, 1M -0.98% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 적중: 예측=bullish, 실제=bullish(+1.50%) | 하락 | -0.03 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 216 | 62.50% | 1.75% | 0.25 | 모멘텀 롱 |
| KOSDAQ | 218 | 56.42% | 0.22% | 0.13 | 모멘텀 롱 |
...
- 누적 표본: 64
- 누적 적중률: 40.62%
- 최근 피드백: 전일 09시 예측 적중: 예측=bullish, 실제=bullish(+1.50%)
...
- [외국인 20일째 "팔자"… 코스피 한때 8000선까지 급락 - chosun.com](https://news.google.com/rss/articles/CBMigAFBVV95cUxPbWpfWFdxa242eEg2ZUNhUXpZWlE5TTBDaVBWTE1Jam9Mc0gzYWdCbDFsSUVYNmdvQW9MS29hUmNBX1lOTlJHU3BYUFJjblp1WngyZzdFN2tuVGd0UWdQOFZzcDVqdnhrNkpfUkZCYi1vemloOVc3d0lvMVdkQkNIdg?oc=5) — chosun.com
...
- [148조원 팔아치운 외국인…하반기엔 ‘셀 코리아’ 멈출까 - marketin.edaily.co.kr](https://news.google.com/rss/articles/CBMic0FVX3lxTE55cm93YWVuMmZfRTBnUC1mZk5zT0xGd0tDVWxLRUJmQWJ1R2dtNlN3RFdOdF9uaElXaWVmTHZLeVNiQjF2R2FGakJMRXN0UkxTX1pYSk9VRVo5cnVjUVd6cks1ejZrdUVEM2JWV1dFeUpsd1U?oc=5) — marketin.edaily.co.kr
