...
- 생성 시각: `2026-06-11T17:36:19+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,763.95 | 2026-06-11 16:40 |
| KOSDAQ | 996.93 | 2026-06-11 16:51 |
| USD/KRW | 1,529.79 | 1M 2.46% |
| SOX | 1W -7.78% | 1M 7.49% |
| VIX | 20.60 | 위험선호/공포 지표 |
| WTI | 89.19 | 1M -12.71% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +3.55%, 3M +47.83%, 6M +98.04% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -92,736억, 10D -288,488억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 123,130억, 기관 5D -36,156억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,529.79, 1M +2.46% | 하락 | -1.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -7.78%, 1M +7.49% | 하락 | -1.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.528%, 1M +3.76% | 하락 | -1.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 20.60 | 상승 | 0.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 89.19달러, 1M -12.71% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +0.00%, 자동차 -1.32% | 상승 | 0.5 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 61.19% | 2.26% | 0.22 | 모멘텀 롱 |
| KOSDAQ | 219 | 55.25% | 0.58% | 0.10 | 모멘텀 롱 |
...
- [[26.6.5 증시 인싸잇] 美 반도체株 타격에 코스피 5.54% 폭락 - 미디어워치](https://news.google.com/rss/articles/CBMiXkFVX3lxTE9EQWNmTVEybE9vdUpRaE5qd3Q5VlNSNGZ5QXAtQU1tMjZmVWV6bXBEQTRSMUdMODlPUTdaYjhSQ1JkRHp6c3A1N0FxeVltMDUtcDZQQXUwM0FucUJLYkE?oc=5) — 미디어워치
