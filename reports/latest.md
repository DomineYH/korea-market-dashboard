...
- 생성 시각: `2026-08-25T16:45:13+09:00`
- 단기 판정: **중립/하락 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-0.84** = 상승 4.5 + 하락 -5.34

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,742.74 | 2026-08-25 16:29 |
| KOSDAQ | 827.15 | 2026-08-25 16:29 |
| USD/KRW | 1,385.87 | 1M -4.95% |
| SOX | 1W -9.49% | 1M -3.35% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/하락 경계 | 조건부 상승 | -0.84 | 4.5 | -5.34 |
| KOSDAQ | 중립 | 상승 우세 | 0.16 | 4.0 | -3.84 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +0.78%, 3M -14.08%, 6M +18.77% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -94,247억, 10D -12,955억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 55,720억, 기관 5D -16,997억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,385.87, 1M -4.95% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 원자재 | WTI 유가 | 84.43달러, 1M +2.20% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 60.73% | 1.76% | 0.21 | 모멘텀 롱 |
| KOSDAQ | 219 | 55.25% | 0.09% | 0.10 | 모멘텀 롱 |
