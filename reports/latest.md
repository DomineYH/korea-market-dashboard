...
- 생성 시각: `2026-07-27T19:44:18+09:00`
- 단기 판정: **중립/상승 경계** / 신뢰도: 중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **1.1** = 상승 5.0 + 하락 -3.9

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,755.75 | 2026-07-27 18:03 |
| KOSDAQ | 764.86 | 2026-07-27 18:03 |
| USD/KRW | 1,468.53 | 1M -5.04% |
| SOX | 1W 4.01% | 1M -8.45% |
| VIX | 17.58 | 위험선호/공포 지표 |
| WTI | 83.11 | 1M 15.56% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립/상승 경계 | 조건부 상승 | 1.1 | 5.0 | -3.9 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -0.9 | 4.5 | -5.4 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -20.25%, 3M +5.75%, 6M +39.56% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -10,972억, 10D -3,548억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 20,896억, 기관 5D -10,162억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,468.53, 1M -5.04% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 17.58 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 83.11달러, 1M +15.56% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=mild_bullish, 실제=bearish(-0.50%) | 하락 | -0.4 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 217 | 64.06% | 1.95% | 0.28 | 모멘텀 롱 |
| KOSDAQ | 218 | 58.72% | 0.04% | 0.17 | 모멘텀 롱 |
...
- 누적 표본: 49
- 누적 적중률: 36.73%
- 최근 피드백: 전일 09시 예측 불일치: 예측=mild_bullish, 실제=bearish(-0.50%)
