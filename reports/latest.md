...
- 생성 시각: `2026-05-20T12:10:15+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,143.66 | 2026-05-20 11:37 |
| KOSDAQ | 1,047.86 | 2026-05-20 09:44 |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +14.87%, 3M +28.80%, 6M +71.37% | 상승 | 2.0 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -194,397억, 10D -435,815억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 180,412억, 기관 5D 11,625억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
...
| 원자재 | WTI 유가 | 104.19달러, 1M +13.09% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
| KOSDAQ | 219 | 55.25% | 0.91% | 0.10 | 모멘텀 롱 |
