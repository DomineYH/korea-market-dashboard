...
- 생성 시각: `2026-07-08T18:26:23+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,246.79 | 2026-07-08 18:02 |
| KOSDAQ | 785.00 | 2026-07-08 17:26 |
| USD/KRW | 1,511.38 | 1M -1.14% |
| SOX | 1W -10.28% | 1M -9.67% |
| VIX | 18.68 | 위험선호/공포 지표 |
| WTI | 75.03 | 1M -17.13% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -10.50%, 3M +32.96%, 6M +71.96% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -104,335억, 10D -288,347억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 97,301억, 기관 5D 1,976억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,511.38, 1M -1.14% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 18.68 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 75.03달러, 1M -17.13% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 220 | 60.00% | 2.19% | 0.20 | 모멘텀 롱 |
| KOSDAQ | 220 | 56.82% | 0.23% | 0.14 | 모멘텀 롱 |
