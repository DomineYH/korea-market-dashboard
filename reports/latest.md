...
- 생성 시각: `2026-09-03T12:19:46+09:00`
...
| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,664.20 | 2026-09-03 11:22 |
| KOSDAQ | 803.67 | 2026-09-03 11:17 |
| USD/KRW | 1,359.38 | 1M -4.83% |
| SOX | 1W -2.34% | 1M -6.90% |
| VIX | 15.20 | 위험선호/공포 지표 |
| WTI | 91.15 | 1M 21.18% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +4.61%, 3M -23.01%, 6M +14.85% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -42,866억, 10D -119,272억 | 하락 | -1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 15,216억, 기관 5D -46,153억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,359.38, 1M -4.83% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.20 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 91.15달러, 1M +21.18% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 60.27% | 1.70% | 0.21 | 모멘텀 롱 |
...
- [코스피, 대외 악재에 변동성 확대…환율·반도체주 흐름 촉각 - 산경투데이](https://news.google.?oc=5) — 산경투데이
