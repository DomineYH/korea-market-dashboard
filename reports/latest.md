...
- 생성 시각: `2026-07-23T18:24:54+09:00`
- 단기 판정: **상승 우세** / 신뢰도: 중간~높음
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **2.1** = 상승 5.0 + 하락 -2.9

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,096.89 | 2026-07-23 17:36 |
| KOSDAQ | 790.28 | 2026-07-23 16:07 |
| USD/KRW | 1,470.08 | 1M -4.24% |
| SOX | 1W 0.10% | 1M -15.20% |
| VIX | 17.49 | 위험선호/공포 지표 |
| WTI | 90.05 | 1M 23% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 상승 우세 | 조건부 상승 | 2.1 | 5.0 | -2.9 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -1.9 | 3.5 | -5.4 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -13.49%, 3M +14.11%, 6M +47.93% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D 42,055억, 10D 56,061억 | 상승 | 1.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -10,537억, 기관 5D -32,309억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,470.08, 1M -4.24% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W +0.10%, 1M -15.20% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 리스크 | VIX | 17.49 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 90.05달러, 1M +23.00% | 하락 | -1.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 63.01% | 1.94% | 0.26 | 모멘텀 롱 |
