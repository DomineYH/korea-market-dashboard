...
- 생성 시각: `2026-08-26T16:48:39+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **0.16** = 상승 4.16 + 하락 -4.0

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,808.21 | 2026-08-26 16:21 |
| KOSDAQ | 826.87 | 2026-08-26 15:34 |
| USD/KRW | 1,384.54 | 1M -5.46% |
| SOX | 1W -3.37% | 1M 0.29% |
| VIX | 15.69 | 위험선호/공포 지표 |
| WTI | 80.16 | 1M 1.14% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립 | 조건부 상승 | 0.16 | 4.16 | -4.0 |
| KOSDAQ | 중립 | 상승 우세 | 0.16 | 3.66 | -3.5 |
...
| 수급 | KOSPI 외국인 순매수 | 5D -60,685억, 10D -14,654억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D -13,063억, 기관 5D 3,990억 | 중립 | 0.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,384.54, 1M -5.46% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -3.37%, 1M +0.29% | 하락 | -1.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
| 펀더멘털 | 반도체/HBM·수출 뉴스 | 수출·반도체·HBM 긍정 키워드 확인 | 상승 | 1.5 | 높음 | 한국 지수의 이익 개선은 반도체 수출 사이클에 크게 의존한다. |
| 금리 | 미국 10년물 | 4.639%, 1M -0.04% | 하락 | 0.0 | 중간~높음 | 미 장기금리 상승은 성장주와 고PER 반도체 밸류에이션을 압박한다. |
| 리스크 | VIX | 15.69 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 80.16달러, 1M +1.14% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 +0.00%, 자동차 -2.65% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
| 국내금리 | 한국은행 기준금리 | 2.50% | 상승 | 0.5 | 중간 | 국내 기준금리 안정은 밸류에이션 하방을 일부 완충한다. |
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=bearish, 실제=bullish(+3.55%) | 상승 | 0.16 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 219 | 60.73% | 1.79% | 0.21 | 모멘텀 롱 |
| KOSDAQ | 219 | 55.71% | 0.11% | 0.11 | 모멘텀 롱 |
...
- 누적 표본: 71
- 누적 적중률: 39.44%
- 최근 피드백: 전일 09시 예측 불일치: 예측=bearish, 실제=bullish(+3.55%)
