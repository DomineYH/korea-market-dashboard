...
- 생성 시각: `2026-07-07T19:27:15+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **-0.47** = 상승 4.03 + 하락 -4.5

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 7,656.31 | 2026-07-07 18:11 |
| KOSDAQ | 831.23 | 2026-07-07 17:58 |
| USD/KRW | 1,516.78 | 1M -2.43% |
| SOX | 1W -2.30% | 1M -7.31% |
| VIX | 15.85 | 위험선호/공포 지표 |
| WTI | 69.18 | 1M -25.64% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립 | 조건부 상승 | -0.47 | 4.03 | -4.5 |
| KOSDAQ | 상승 우세 | 상승 우세 | 2.53 | 4.53 | -2.0 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +2.30%, 3M +42.38%, 6M +81.41% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -124,800억, 10D -338,330억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 115,029억, 기관 5D 4,828억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,516.78, 1M -2.43% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -2.30%, 1M -7.31% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 리스크 | VIX | 15.85 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 69.18달러, 1M -25.64% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
| 업종 | 반도체/자동차 장중 흐름 | 반도체 -6.57%, 자동차 -4.38% | 하락 | -1.0 | 높음 | KOSPI 지수 기여도가 큰 업종이 밀리면 지수 조정 압력이 커진다. |
| 국내금리 | 한국은행 기준금리 | 2.50% | 상승 | 0.5 | 중간 | 국내 기준금리 안정은 밸류에이션 하방을 일부 완충한다. |
| 피드백 | 전일 09시 예측 vs 마감 장세 | 전일 09시 예측 불일치: 예측=neutral, 실제=bullish(+0.74%) | 상승 | 0.53 | 동적 | 전일 오전 예측과 마감 장세의 적중/불일치 결과를 다음 장세 예측 점수에 반영한다. |

## 백테스트 요약

| 시장 | 표본 | 승률 | 평균 선행수익률 | 제안 가중치 | 우수 신호 |
|---|---:|---:|---:|---:|---|
| KOSPI | 220 | 60.00% | 2.25% | 0.20 | 모멘텀 롱 |
| KOSDAQ | 220 | 56.82% | 0.32% | 0.14 | 모멘텀 롱 |
...
- 누적 표본: 35
- 누적 적중률: 42.86%
- 최근 피드백: 전일 09시 예측 불일치: 예측=neutral, 실제=bullish(+0.74%)
