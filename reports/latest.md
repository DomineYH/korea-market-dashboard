...
- 생성 시각: `2026-08-07T11:41:42+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
- 총점: **0.22** = 상승 5.0 + 하락 -4.78

## 핵심 시장 지표

| 항목 | 값 | 비고 |
|---|---:|---|
| KOSPI | 6,220.38 | 2026-08-07 11:24 |
| KOSDAQ | 779.72 | 2026-08-07 11:24 |
| USD/KRW | 1,419.58 | 1M -5.57% |
| SOX | 1W 6.60% | 1M -4.19% |
| VIX | 15.15 | 위험선호/공포 지표 |
| WTI | 78.11 | 1M 6.24% |
...
|---|---|---|---:|---:|---:|
| KOSPI | 중립 | 조건부 상승 | 0.22 | 5.0 | -4.78 |
| KOSDAQ | 중립/하락 경계 | 중립/상승 경계 | -0.78 | 4.5 | -5.28 |

## 예측 모델표

| 분류 | 신호 | 관측값 | 방향 | 점수 | 가중 | 해석 |
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M -13.88%, 3M -16.68%, 6M +19.45% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
| 수급 | KOSPI 외국인 순매수 | 5D -52,490억, 10D -53,122억 | 하락 | -2.0 | 매우 높음 | 한국 시장은 외국인 매매가 단기 방향을 지배하는 경우가 많다. |
| 수급 | KOSPI 개인 순매수 방어 | 개인 5D 74,395억, 기관 5D -24,814억 | 하락 | -1.0 | 중간 | 외국인 매도를 개인이 받아내는 구조는 단기 과열/분산 매물 신호가 될 수 있다. |
| 환율 | USD/KRW | 1,419.58, 1M -5.57% | 하락 | -0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
...
| 리스크 | VIX | 15.15 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 78.11달러, 1M +6.24% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
