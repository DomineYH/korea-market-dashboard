...
- 생성 시각: `2026-08-29T04:18:23+09:00`
- 단기 판정: **중립** / 신뢰도: 낮음~중간
- 중기 판정: **조건부 상승** / 신뢰도: 중간
...
| USD/KRW | 1,378.82 | 1M -4.40% |
| SOX | 1W -2.29% | 1M 1.49% |
| VIX | 14.54 | 위험선호/공포 지표 |
| WTI | 83.30 | 1M -0.35% |
...
|---|---|---|---|---:|---|---|
| 가격/추세 | KOSPI 중기 모멘텀 | 1M +14.75%, 3M -16.00%, 6M +18.24% | 상승 | 0.5 | 높음 | 지수 자체의 중기 추세가 강하면 급락보다 눌림 후 재상승 확률이 커진다. |
...
| 환율 | USD/KRW | 1,378.82, 1M -4.40% | 하락 | 0.5 | 높음 | 원화 약세는 외국인 환차손 우려와 할인율 부담을 높인다. |
| 글로벌/반도체 | Philadelphia SOX 단기 흐름 | 1W -2.29%, 1M +1.49% | 하락 | 0.0 | 높음 | 한국 반도체 대형주는 미국 반도체 지수와 단기 연동성이 높다. |
...
| 리스크 | VIX | 14.54 | 상승 | 1.0 | 중간 | VIX 20 이하에서는 위기성 급락보다 일반 조정일 가능성이 커진다. |
| 원자재 | WTI 유가 | 83.30달러, 1M -0.35% | 하락 | 0.0 | 중간 | 고유가는 한국의 비용·무역수지·물가 부담을 키운다. |
...
|---|---:|---:|---:|---:|---|
| KOSPI | 218 | 61.47% | 1.81% | 0.23 | 모멘텀 롱 |
